      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {vehicles.map((vehicle) => {
            ...
            // Vehicle sub-pages (/routes/[slug]/[vehicle]) are pre-built ONLY
            // for routes where the FROM city is a hub (kolkata/ranchi/bhubaneswar/jamshedpur/patna).
            //
            // Linking rules:
            //  • Hub-origin route page → /routes/[slug]/[vehicle]      ("View Details")
            //  • Non-hub route page    → /routes/[slug]#booking-form    ("Book Now")
            //  • Any city page         → #booking-form                  ("Book Now")
            ...
            const btnLabel = isHubOriginRoute ? 'View Details' : 'Book Now';
